            ...
            <td data-import-upload-size="{$IMPORT_UPLOAD_SIZE}" data-import-upload-size-mb="{$IMPORT_UPLOAD_SIZE_MB}">
                <div>
                    ...
                    <div class="fileUploadBtn btn btn-primary">
                        ...
                        <input type="file" name="import_file" id="import_file" onchange="Vtiger_Import_Js.checkFileType(event)" data-file-formats="{if $FORMAT eq '' or $FORMAT eq 'csv'}csv|xls|xlsx{elseif $FORMAT eq 'xlsx' or $FORMAT eq 'xls'}xls|xlsx{else}{$FORMAT}{/if}" />
                    </div>
