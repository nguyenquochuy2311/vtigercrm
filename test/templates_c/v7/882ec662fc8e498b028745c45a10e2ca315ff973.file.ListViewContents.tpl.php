...
<?php /*%%SmartyHeaderCode:20116492996a12c4adc2b7b5-03215835%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '20116492996a12c4adc2b7b5-03215835',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6a12c4adc4695',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6a12c4adc4695')) {function content_6a12c4adc4695($_smarty_tpl) {?>
...
&nbsp;</a><?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value==$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')){?><a href="#" class="removeSorting"><i class="fa fa-remove"></i></a><?php }?></th><?php }?><?php } ?></tr></thead><tbody class="overflow-y"><?php if ($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->isQuickSearchEnabled()&&!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value){?><tr class="searchRow listViewSearchContainer"><th class="user-inline-search-btn"><div class="table-actions"><?php $_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH'] = new Smarty_variable(false, null, 0);?><?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==0||(is_array($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value[0])&&count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value[0])==0&&count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value)==1)){?><?php $_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH'] = new Smarty_variable(true, null, 0);?><?php }?><button class="btn btn-sm btn-success <?php if (!$_smarty_tpl->tpl_vars['HIDE_CLEAR_SEARCH']->value){?>hide<?php }?>" data-trigger="listSearch"><i class="fa fa-search"></i> &nbsp;<span class="s2-btn-text"><?php echo vtranslate("LBL_SEARCH",$_smarty_tpl->tpl_vars['MODULE']->value);?>
